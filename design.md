...
colors:
  defaultText: "#10288C"
  defaultBackground: "#B6DB00"
  alternateText: "#EAF6AD"
  alternateBackground: "#274DEA"
  action: "#10288C"
  hover: "#10288C"
  buttonText: "#EAF6AD"
typography:
...
- Default Text on Default Background: 7.70:1 — meets the 4.5:1 target for normal text.
- Alternate Text on Alternate Background: 5.48:1 — meets the 4.5:1 target for normal text.
- Links and buttons on Default Background: 7.70:1 — meets the 4.5:1 target for normal text.
- Links and buttons on hover on Default Background: 7.70:1 — meets the 4.5:1 target for normal text.
- Button text: 10.73:1 — meets the 4.5:1 target for normal text.
- Button text on hover: 10.73:1 — meets the 4.5:1 target for normal text.

## Typography

The base font size is 16px. Use Mulish for body text and Philosopher for headings. All size values use rem so changing the root size scales the full type system.
